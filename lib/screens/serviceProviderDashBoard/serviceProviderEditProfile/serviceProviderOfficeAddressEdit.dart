...
class ServiceProviderOfficeAddressEditDialog extends StatefulWidget {
  const ServiceProviderOfficeAddressEditDialog({super.key});

  @override
  State<ServiceProviderOfficeAddressEditDialog> createState() => _ServiceProviderOfficeAddressEditDialogState();
}

class _ServiceProviderOfficeAddressEditDialogState extends State<ServiceProviderOfficeAddressEditDialog> {
        ...
        child: Container(
          child: Column(
              ...
              children: [
                ...
                new GestureDetector(
                  onTap: (){
                    Navigator.pop(context, officeAddressController.text);
                  },
                  child: Container(
                      width: 70.0,
                      height: 30.0,
