...
class ServiceProviderEmailAddressEditDialog extends StatefulWidget {
  const ServiceProviderEmailAddressEditDialog({super.key});

  @override
  State<ServiceProviderEmailAddressEditDialog> createState() => _ServiceProviderEmailAddressEditDialogState();
}

class _ServiceProviderEmailAddressEditDialogState extends State<ServiceProviderEmailAddressEditDialog> {
